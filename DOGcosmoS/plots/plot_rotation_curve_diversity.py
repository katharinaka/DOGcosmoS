...
def plot_vfid_vmax(vmax_min_sample=60, vmax_max_sample=120, title='Rotation curve diversity', legend='simulation data', plot_NFW_ref=True, save_as='vfid_vs_vmax.png', dpi=200):
