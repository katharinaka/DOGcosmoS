...
def quantify_rotation_curve_shapes(vmax_min_sample=60, vmax_max_sample=120, save=False):
    ...
    """
    sample_indices = select_sample(vmax_min_sample, vmax_max_sample, save=False)
    ...
    for i in range(len(sample_indices)):
        ...
        r, vcirc = vcirc_total(halo_index, save=False)
